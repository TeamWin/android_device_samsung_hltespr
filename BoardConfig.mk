...
TARGET_PREBUILT_KERNEL := device/samsung/hltespr/zImage
TARGET_PREBUILT_DTB := device/samsung/hltespr/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/hltespr/bootimg.mk
